import { Text, StyleSheet, View, SafeAreaView, Image, ScrollView, ImageBackground } from 'react-native'
...
export default class Money extends Component {
  ...
  render() {
    return (
      <SafeAreaView style={{ backgroundColor: '#fff', flex: 1, paddingLeft: 20, paddingRight: 20 }}>

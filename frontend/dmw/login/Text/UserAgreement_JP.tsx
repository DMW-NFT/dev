const UserAgreement_JP =  `<p class="MsoNormal" align="center" style="text-align:center;">
<b> </b> 
</p>
...
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  1)&nbsp;&nbsp;
本利用規約（以下「本規約」といいます。）は、DMWアプリケーション（以下は「本アプリ」といいます。）により提供するダウンロード、インストール、登録等のサービスに利用につき、本サービスの利用者及び利用者になろうとする者が遵守すべき事項を定めるものです。
</p>
...
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  1)&nbsp;&nbsp;
天災地変、戦争、テロ、暴動、労働争議、法令・規則の制定改廃、政府機関の介入又は命令、伝染病、停電、など不可抗力により、サービスの全部又は一部を提供できない場合、ユーザーに生じた損害について、当社は一切責任を負いません。
</p>
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  2)&nbsp;&nbsp;
当社は、利用者に対し、適宜情報提供やアドバイスを行うことがあるが、それにより責任を負うものではない。
</p>
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  3)&nbsp;&nbsp;
利用者が本規約等に違反したことによって生じた損害については、当社は一切責任を負わない。
</p>
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  4)&nbsp;&nbsp;
通信回線やコンピュータ等の障害・システムメンテナンス等による生じた損害については、当社は一切責任を負いません。
</p>
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  5)&nbsp;&nbsp;
前各項のほか、DMWが予測する、また控えることができない事情により生じた損害につて、DMWは一切責任を負いません。
</p>
<p class="MsoNormal" align="left" style="text-align:left;">
  <br />
</p>
...
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  1)&nbsp;&nbsp;
DMWが本規約を改定する場合、DMWはウェブサイトへの掲載その他当社所定の方法により利用者に告知するものとします。ユーザーが本アプリを利用続けた場合、利用者は、本規約に同意したものとみなします。
</p>
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  2)&nbsp;&nbsp;
本規約のすべての条件のタイトルは読みやすいためのもので、それ自体が実際の意味を持っていないので、本規約の意味解釈の根拠にはならないことをご承知おきください。
</p>
<p class="MsoListParagraph" align="left" style="margin-left:21.0pt;text-align:left;text-indent:-21.0pt;">
  3)&nbsp;&nbsp;
本規約の条項はいかなる理由で一部が無効であっても、他の条項は依然として有効であり、お互いに対して拘束力があるものとします。
</p>
<p class="MsoNormal" align="left" style="text-align:left;">
  <br />
</p>
...
export default UserAgreement_JP;
